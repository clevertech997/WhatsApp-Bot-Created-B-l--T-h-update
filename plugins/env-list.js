...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: `https://img.sanishtech.com/u/b0c467fbcb2761a1e29d00110d267e5b.png` },
                caption: envSettings,
                contextInfo: {
        ...
        await conn.sendMessage(from, {
            audio: { url: 'https://image2url.com/r2/default/audio/1768927330510-cf61b3db-2f29-4c66-8ecb-bb2fefa29faf.mp3' }, // Audio URL
            mimetype: 'audio/mp4',
            ptt: true
        }, { quoted: mek });
