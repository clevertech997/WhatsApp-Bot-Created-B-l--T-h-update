...
async(conn, mek, m, {from, l, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, isItzcp, groupAdmins, isBotAdmins, isAdmins, reply}) => {
    try {
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: `https://img.sanishtech.com/u/4e11f8768f009e7023dac67e8cec07bc.png` },
                caption: dec,
                contextInfo: {
                    ...
                    forwardedNewsletterMessageInfo: {
                        ...
                        newsletterName: 'CLEVER-TECH SUPPORT',
                        serverMessageId: 143
                    }
                }
            },
        ...
        await conn.sendMessage(from, {
            audio: { url: 'https://image2url.com/r2/default/audio/1768927330510-cf61b3db-2f29-4c66-8ecb-bb2fefa29faf.mp3' },
            mimetype: 'audio/mp4',
            ptt: false
        }, { quoted: mek });
